...
main = tkinter.Tk()
main.title("UPI Fraud Detection") #designing main screen
...
def runLR():
    ...
    text.insert(END,"Prediction Results\n\n") 
    prediction_data = prediction(X_test, cls) 
    lr_acc = cal_accuracy(y_test, prediction_data,'LR Accuracy')
...
def runNB():
    ...
    text.insert(END,"Prediction Results\n\n") 
    prediction_data = prediction(X_test, cls) 
    lr_acc = cal_accuracy(y_test, prediction_data,'NB Accuracy')
...
font = ('times', 16, 'bold')
title = Label(main, text='UPI Fraud Detection Using Random Forest Tree Based Classifier')
...
font1 = ('times', 14, 'bold')
uploadButton = Button(main, text="Upload UPI Dataset", command=upload)
...
runrandomButton = Button(main, text="Run LR Algorithm", command=runLR)
runrandomButton.place(x=950,y=550)
runrandomButton.config(font=font1) 

runrandomButton = Button(main, text="Run NB Algorithm", command=runNB)
runrandomButton.place(x=1150,y=550)
runrandomButton.config(font=font1) 
